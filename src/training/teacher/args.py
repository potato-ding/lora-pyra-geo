...
def build_arg_parser():
    ...
    parser.add_argument('--training_stage', type=str, choices=['auto', 'sample4geo', 'identity'], default='auto', help='Explicit staged-restart mode; auto keeps the sample4geo/identity curriculum')
